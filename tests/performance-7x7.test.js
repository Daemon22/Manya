...
import {
  HelixFlowClient as _HelixFlowClient,
...
import { hash, hashWithSalt as _hashWithSalt } from '../tools/forge/src/hash.js';
import { timingSafeEqual as _timingSafeEqual, timingSafeCompare as _timingSafeCompare } from '../tools/forge/src/timing.js';
...
import { audit as _stampAudit, buildTrail, verifyTrail } from '../tools/stamp/src/audit.js';

// -- Vault imports --
import { create as vaultCreate, put as vaultPut, get as vaultGet, del as vaultDel, keys as vaultKeys, has as vaultHas, size as vaultSize, seal as vaultSeal, open as vaultOpen, inspect as _vaultInspect, search as vaultSearch } from '../tools/vault/src/store.js';

// -- Lens imports --
import { detect as lensDetect } from '../tools/lens/src/detect.js';
import { redact, scan, PRESETS } from '../tools/lens/src/redact.js';
import { classify, profile, LEVELS as _LEVELS } from '../tools/lens/src/classify.js';

// -- Shield imports --
import { createPolicy, defineRole, grant, revoke as _revoke, registerSubject, assignRole, removeRole as _removeRole, checkAccess, addRule, getEffectivePermissions } from '../tools/shield/src/policy.js';
import { auditAccess as _auditAccess, buildAuditTrail, verifyAuditTrail } from '../tools/shield/src/audit.js';
...
// -- Pulse imports --
import { getIndustry, listIndustries, createRedactionConfig, createIndustryPolicy, createAuditTemplate, createPreset, INDUSTRIES as _INDUSTRIES, INDUSTRY_IDS } from '../tools/pulse/src/index.js';

// -- Primary Sector imports --
import { getSector as _getSector, listSectors, validateCoordinates, validateCommodity, validateSensorReading, validateProductionReport, createPreset as createSectorPreset, checkCompliance, SECTORS, SECTOR_IDS as _SECTOR_IDS } from '../tools/primary-sector/src/index.js';

// -- Cybersecurity imports --
import { classifyThreat, createIOC, createCVEReference as _createCVEReference, calculateCVSS, createVulnerability, assessRisk, getFramework as _getFramework, createAssessment as _createAssessment, createEvidence, verifyEvidenceIntegrity, validateChainOfCustody as _validateChainOfCustody, createIncident, escalateIncident, classifyIncident as _classifyIncident } from '../tools/cybersecurity/src/index.js';
...
import {
  ...
  validateWagonNumber as _validateWagonNumber,
  validateFlightNumber as _validateFlightNumber,
  validateHSCode as _validateHSCode,
  validateTIRCarnet as _validateTIRCarnet,
  validateCountryCode as _validateCountryCode,
  createShipment,
  recordEvent,
  createGeofence,
  checkGeofence,
  estimateETA as _estimateETA,
  lookupDangerousGood,
  createDangerousGoodsDeclaration,
  screenSanctions,
  createCustomsDeclaration as _createCustomsDeclaration,
  checkCompliance as _checkTransportCompliance,
...
import {
  ...
  validateORCID,
  validateArxivID,
  validatePMID as _validatePMID,
  validateNCT as _validateNCT,
  validateROR as _validateROR,
  validateISBN13,
  createManifest,
  verifyManifest,
  assessFAIR,
  ...
  recordReview,
  recordDecision,
  recordRevision as _recordRevision,
...
import {
  registerTool,
  unregisterTool as _unregisterTool,
  listTools as _listTools,
...
// -- CLI imports --
import { parseArgs, tryParseJson as _tryParseJson } from '../tools/cli/src/parser.js';
...
import {
  ...
  createDownloadEvent,
  LYCON_SYNC_CHANNELS,
  LYCON_CAPABILITIES as _LYCON_CAPABILITIES,
...
import {
  ...
  UPMP_SYNC_CHANNELS,
  UPMP_CAPABILITIES as _UPMP_CAPABILITIES,
  DEFAULT_INTELLIGENCES as _DEFAULT_INTELLIGENCES,
...
function _makeBuffer(pattern, size) {
...
test('D9a: compose + signalSeal + signalOpen - encrypted message roundtrip', () => {
  ...
  const { envelope: opened, metadata: _metadata } = signalOpen(sealed, PASS);
...
test('D18b: mesh register-all via dispatcher - registers all 8 CLI-accessible tools', async () => {
